...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_description_SOURCE_PREFIX /home/mapping/catkin_ws/src/kobuki_description)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mapping/catkin_ws/src/kobuki_description/${idir}'.  ${_report}")
    endif()
